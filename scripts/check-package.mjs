...
for (const file of ['lib/index.js', 'lib/index.d.ts', 'lib/system.js', 'lib/memory.js', 'lib/file.js', 'lib/file.d.ts', 'lib/filetoolkit.js', 'lib/filetoolkit.d.ts', 'lib/sentry.js', 'lib/datadog.js', 'NitroLogger.podspec', 'nitro.json', 'ios/HybridSystemLogSink.swift', 'nitrogen/generated/ios/NitroLogger+autolinking.rb', 'nitrogen/generated/android/NitroLogger+autolinking.gradle', 'android/src/main/java/com/margelo/nitro/nitrologger/HybridSystemLogSink.kt', 'LICENSE']) assert(paths.has(file), `Missing package file: ${file}`);
...
const { createFileTransport } = await import('../packages/react-native-nitro-logger/lib/file.js');
assert.equal(typeof createFileTransport, 'function');
